...
public class PestanasEj3 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pestanas_ej3);
...
//Añadimos iconos a las pestañas
        tabLayout.getTabAt(0).setIcon(R.drawable.ic_avion);
        tabLayout.getTabAt(1).setIcon(R.drawable.ic_audio_track);
    }
